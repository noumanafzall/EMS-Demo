...
function Sidebar({list}) {
  return (
      ...
      <div className='bg-[#231e3b] h-[100vh] w-[200px] flex flex-col border border-solid border-gray-500 border-t-0 border-r-2 border-b-0 border-l-0  shadow-md justify-between items-center rounded-r-md'>
