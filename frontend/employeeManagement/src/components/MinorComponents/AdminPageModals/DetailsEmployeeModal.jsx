...
function DetailsEmployeeModal({closeModal, employee}) {
  ...
  return (
    <div className='w-full h-screen backdrop-blur-[2px] fixed flex justify-center items-center '>
      <div className='w-96 h-[90%] border rounded-md text-white bg-[#231e3b] shadow-xl flex flex-col p-6 overflow-y-auto'>
        ...
        <h2 className='text-3xl font-bold text-center py-4'>Employee Details</h2>
        ...
        <div>
          ...
          <button
            type='button'
            className='w-full bg-blue-500 text-white rounded-md py-2 px-4 hover:bg-blue-600 transition duration-300' onClick={() => close()}
            >
            Close
          </button>
        </div>
...
export default DetailsEmployeeModal